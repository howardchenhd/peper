...
def main(params):
    ...
    encoder = TransformerModel(model_params, src_dico, is_encoder=True, with_output=True).cuda().eval()
    ...
    for i in range(0, len(src_sent), params.batch_size):
        ...
        decoded, dec_lengths = decoder.generate_beam(encoded, lengths.cuda(), params.tgt_id,beam_size = params.beam_size, length_penalty=1,early_stopping=False)
