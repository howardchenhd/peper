...
class Trainer(object):
    ...
    def __init__(self, data, params):
        ...
        counts = np.array(list(self.data['dico']['src'].counts.values()))
    ...
    def get_iterator(self, iter_name, lang1, lang2, stream):
        ...
        if lang2 is None:
            ...
            if self.data['para'][(_lang1, _lang2)]['train'] is None: # Zero Shot Data
                return None
    ...
    def save_checkpoint(self, str=''):
        ...
        checkpoint_path = os.path.join(self.params.dump_path, 'checkpoint.pth'+str  )
